...
x=seq(40,85,.1)
y=21.75*x^2/1549.84786
plot(x,y,type="n",xlab="Height (inches)",
     ylab="Weight (Kgs)",ylim=c(20,100))
curve(18.5*x^2/1549.84786,from=40,to=85,add=T,col="purple", lwd = 2)
curve(25*x^2/1549.84786,from=40,to=85,add=T,col="purple", lwd = 2)
segments(70,17,70,25*70^2/1549.84786)
segments(37,18.5*70^2/1549.84786,70,18.5*70^2/1549.84786)
segments(37,25*70^2/1549.84786,70,25*70^2/1549.84786)
text(50,82,"79 Kgs")
text(50,62,"58.5 Kgs")
text(75,48,"70 inches")
